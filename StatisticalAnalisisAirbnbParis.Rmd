...
A continuación se muestra muestra una grafica de barras apliadas de estas dos variables y tambien se muestra una tabla cruzada:
...
plot(baseSinAtipicos$realSum, baseSinAtipicos$cleanliness_rating)
```
