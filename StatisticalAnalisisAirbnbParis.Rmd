...
tabla cruzada
```{r, warning=FALSE}
tabla <- crosstab(room_type,biz,prop.c = TRUE,plot = FALSE)
tabla
...
```{r, warning=FALSE}
with(paris_weekdays, chisq.test(room_type, biz , correct = TRUE, p = rep(1/length(room_type),length(room_type))))
