...
baseSinAtipicos <- filter(Paris_weekdays, Paris_weekdays$realSum < 900)
baseSinAtipicos1 <-  filter(baseSinAtipicos, baseSinAtipicos$room_type == "Entire home/apt")

plot(baseSinAtipicos1$realSum, baseSinAtipicos1$person_capacity)
plot(baseSinAtipicos1$realSum, baseSinAtipicos1$cleanliness_rating)
```
