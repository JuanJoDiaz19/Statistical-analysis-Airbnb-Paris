...
#### **Precios del AirBnb deacuerdo al si el cuarto es compartido**
...
Antes de ejecutar el coddigo de anova podemos mirar como ser verian los diagramas de cajas y bigotes de estos 3 grupos:
...
Queremos probar si hay una relacion entre los años de experiencia y el salario, por lo que se hacen la siguientes hipotesis:
...
En este caso no podemos aplicar la prueba de independencia de los residuos puesto que el analisis entre la distancia y el precio final o tiene series de tiempo.
