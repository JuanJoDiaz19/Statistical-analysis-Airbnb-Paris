...
setwd('D:/santy/inferencia/Statistical-analysis-Airbnb-Paris')
...
CalificacionDeLimpiezaSinAtipicos <- CalificacionDeLimpieza[CalificacionDeLimpieza < (mean_val + 3*sd_val) & CalificacionDeLimpieza > (mean_val - 3*sd_val)]
...
#```{r, warning=FALSE}
#with(paris_weekdays, chisq.test(TipoDeCuarto, FinesDeNegocios , correct = #TRUE, p = rep(1/length(TipoDeCuarto),length(TipoDeCuarto))))
