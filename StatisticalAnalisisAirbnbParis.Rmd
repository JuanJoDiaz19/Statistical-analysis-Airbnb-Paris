...
descriptivas <- stat.desc(CalificacionDeLimpieza)
descriptivas
```
...
CalificacionDeLimpiezaSinAtipicos <- CalificacionDeLimpieza[CalificacionDeLimpieza < (mean_val + 3.5*sd_val) & CalificacionDeLimpieza > (mean_val - 3.5*sd_val)]
