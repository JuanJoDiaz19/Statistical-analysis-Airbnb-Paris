...
### **Regresion lineal - PONER CUALES SON LAS VARIABLES QUE QUEREMOS HACER JEJEJE**

```{r}
#names(Paris_weekdays)
baseSinAtipicos <- filter(Paris_weekdays, Paris_weekdays$realSum < 1500)
baseSinAtipicos1 <-  filter(baseSinAtipicos, baseSinAtipicos$room_type == "Entire home/apt")
baseSinAtipicos1 <-  filter(baseSinAtipicos1, baseSinAtipicos1$person_capacity == 2)
baseSinAtipicos1 <-  filter(baseSinAtipicos1, baseSinAtipicos1$multi == 1)
baseSinAtipicos1 <-  filter(baseSinAtipicos1, baseSinAtipicos1$cleanliness_rating == 10)
...
#baseSinAtipicos1 <-  filter(baseSinAtipicos1, baseSinAtipicos1$person_capacity > 4)
