...
```{r}
with(datos, (t.test(PrecioFinalSinAtipicos4, alternative = "greater", mu =200, conf.level = 0.95)))

```

Vemos que el valor p es bastante pequeño, (menor al 0.05) asi que podemos rechazar esta hipotesis nula y podemos concluir que los Airbnb en paris tiene un precio mayor a 200 Euros.
